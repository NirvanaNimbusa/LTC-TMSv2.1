firebase.auth().onAuthStateChanged(function (firebaseUser){
  ...
  window.onload=function(){
    console.log("HELLO");
      ...
      document.getElementById("time123").innerHTML = "早上好 &nbsp ";
    }
    if(time123>="12:00:00" && time123<"18:00:00"){
      document.getElementById("time123").innerHTML = "下午好 &nbsp ";
    }
    if(time123>="18:00:00" || time123<"04:00:00"){
      document.getElementById("time123").innerHTML = "晚上好 &nbsp ";
    }
  }
