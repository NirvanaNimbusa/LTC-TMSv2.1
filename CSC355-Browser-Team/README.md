...
The browser version can be accessed by clicking [here](https://mcultc4.firebaseapp.com/Frontend/00Login2.html). This link was generated using the files completed during Sprint 4 and the following command:
```
firebase deploy
```
